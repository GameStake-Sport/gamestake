...
export function FloatingInbox({
  ...
  const initXmtpWithKeys = async function () {
    ...
    // Add this: Initialize default conversation
    try {
      const conversation = await xmtp.conversations.newConversation(DEFAULT_CONVERSATION_ADDRESS);
  ...
  // Remove or comment out the separate initDefaultConversation function if it exists
